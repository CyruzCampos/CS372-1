 ...
 * display_children_in_school(), display_people_in_City_Hall(), and pay_employees.
 */
public class City {
/**
* The population ArrayList creates an array to hold how many people are created overall.
* The buildings ArrayList creatss an array to hold how many buildings are created overall.
*/
 ...
 */
	public static void we_built_this_city() {
		...
		buildings.add(new School("Sheridan Elementary", "3737 E 5th Ave, Spokane"));
