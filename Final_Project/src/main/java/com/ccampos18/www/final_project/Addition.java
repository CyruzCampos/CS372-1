...
/**
 * Addition class that shows only addition problems to the users, each problem is randomly generated.
...
public class Addition extends AppCompatActivity {
     ...
     */
    public void Message () {
        AlertDialog Text = new AlertDialog.Builder(Addition.this).create();
        ...
        Text.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Addition.this, Game_Choice.class));
            }
        });
        Text.show();
    }
