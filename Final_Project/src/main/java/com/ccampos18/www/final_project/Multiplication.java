...
/**
 * Multiplication class that shows only multiplication problems to the users, each problem is randomly generated.
...
public class Multiplication extends AppCompatActivity {
     ...
     */
    public void Message () {
        AlertDialog Text = new AlertDialog.Builder(Multiplication.this).create();
        ...
        Text.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Multiplication.this, Game_Choice.class));
            }
        });
        Text.show();
    }
    ...
    public void Questions () {
        ...
        String Q = String.format("%d x %d", Num_1, Num_2);
        ...
        int R_Answer_1 = Random.nextInt(2000) + 1;
        int R_Answer_2 = Random.nextInt(2000) + 1;
        int R_Answer_3 = Random.nextInt(2000) + 1;
        int R_Answer_4 = Random.nextInt(2000) + 1;
