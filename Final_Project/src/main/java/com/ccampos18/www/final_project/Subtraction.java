...
/**
 * Subtraction class that shows only subtraction problems to the users, each problem is randomly generated.
...
public class Subtraction extends AppCompatActivity {
     ...
     */
    public void Message () {
        AlertDialog Text = new AlertDialog.Builder(Subtraction.this).create();
        ...
        Text.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Subtraction.this, Game_Choice.class));
            }
        });
        Text.show();
    }
